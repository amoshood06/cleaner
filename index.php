...
<body class="bg-white overflow-x-hidden">
    ...
    <header class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <!-- Navigation Links -->
        <nav id="menu" class="hidden md:flex space-x-8 absolute md:static top-16 left-0 w-full md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none md:space-x-8 md:flex-row flex-col md:items-center">
